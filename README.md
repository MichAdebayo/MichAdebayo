...
<!-- INTERESTED IN -->
  <!-- <div style="display: flex; align-items: flex-start; justify-content: center; font-size: 12px; margin: 6px 0; padding-left: 16px;"> -->
<div style="display: flex; align-items: flex-start; justify-content: center; font-size: 12px; margin: 6px 0; padding-left: 16px;"><img src="https://github.com/user-attachments/assets/056c7200-7ffb-41a1-b318-25447b43ec33" height="25px"></div>
